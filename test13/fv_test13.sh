...
fvctl -f /dev/null add-flowspace VN1_flow2 1 100 in_port=2,tp_dst=4000 VN1=7

# Switch: S2
fvctl -f /dev/null add-flowspace -q 1 VN1_flow3 2 100 in_port=1,tp_src=4000 VN1=7
fvctl -f /dev/null add-flowspace VN1_flow4 2 100 in_port=2,tp_dst=4000 VN1=7

# ---- Slice 2 (VN2) ---- #

# Switch: S1
fvctl -f /dev/null add-flowspace -q 2 VN2_flow1 1 10 in_port=1,tp_src=5000 VN2=7
fvctl -f /dev/null add-flowspace VN2_flow2 1 10 in_port=2,tp_dst=5000 VN2=7

# Switch: S2
fvctl -f /dev/null add-flowspace -q 2 VN2_flow3 2 10 in_port=1,tp_src=5000 VN2=7
fvctl -f /dev/null add-flowspace VN2_flow4 2 10 in_port=2,tp_dst=5000 VN2=7
