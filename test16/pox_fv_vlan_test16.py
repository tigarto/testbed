...
def _handle_PacketIn(event):
	...
	if event.connection.dpid==s1_dpid:
	   ...
	   # Flujos para la tabla de flujos del switch
		...
		flow_s1_0out = of.ofp_action_output(port = 3)
		flow_s1_0.actions = [flow_s1_0vlan_id,flow_s1_0out]
		...
		flow_s1_1out = of.ofp_action_output(port = 3)
		flow_s1_1.actions = [flow_s1_1vlan_id,flow_s1_1out]
	...
	if event.connection.dpid==s2_dpid:			
		...
		flow_s2_0out = of.ofp_action_output(port = 1)
		flow_s2_0.actions = [flow_s2_0vlan_id,flow_s2_0out]
		...
		flow_s2_1out = of.ofp_action_output(port = 1)
		flow_s2_1.actions = [flow_s2_1vlan_id,flow_s2_1out]
