...
For running type:
sudo mn --custom topo_test17.py --topo topo_test17 --link tc --controller remote --mac --arp
			
'''

class topoTest17(Topo):
	def __init__(self):
...
topos = { 'topo_test17': ( lambda: topoTest17() ) }
