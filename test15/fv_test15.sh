...
# Switch: S1
fvctl -f /dev/null add-flowspace VN1_flow1 1 100 in_port=1 VN1=4
fvctl -f /dev/null add-flowspace VN1_flow2 1 100 in_port=3,dl_vlan=50 VN1=4


# ---- Slice 2 (VN2) ---- #

# Switch: S1
fvctl -f /dev/null add-flowspace VN2_flow1 1 100 in_port=2 VN2=4
fvctl -f /dev/null add-flowspace VN2_flow2 1 100 in_port=3,dl_vlan=60 VN2=4
