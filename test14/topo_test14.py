...
For running type:
sudo mn --custom topo_test14.py --topo topo_test14 --link tc --controller remote --mac --arp
			
'''

class topoTest14(Topo):
	def __init__(self):
...
topos = { 'topo_test14': ( lambda: topoTest14() ) }
