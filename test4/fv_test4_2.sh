...
fvctl -f /dev/null add-slice VN1 tcp:localhost:10002 araif@udea.edu.co
...
fvctl -f /dev/null add-flowspace VN2_flow2 1 10 in_port=1 VN2=7
fvctl -f /dev/null add-flowspace VN2_flow3 2 10 any VN2=7
